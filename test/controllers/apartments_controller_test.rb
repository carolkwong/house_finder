...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { address: @apartment.address, bedrooms: @apartment.bedrooms, decimal: @apartment.decimal, description: @apartment.description, district: @apartment.district, elevator: @apartment.elevator, furnished: @apartment.furnished, latitude: @apartment.latitude, longtitude: @apartment.longtitude, price: @apartment.price, size: @apartment.size, status: @apartment.status, user: @apartment.user, year_built: @apartment.year_built } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { address: @apartment.address, bedrooms: @apartment.bedrooms, decimal: @apartment.decimal, description: @apartment.description, district: @apartment.district, elevator: @apartment.elevator, furnished: @apartment.furnished, latitude: @apartment.latitude, longtitude: @apartment.longtitude, price: @apartment.price, size: @apartment.size, status: @apartment.status, user: @apartment.user, year_built: @apartment.year_built } }
